...
#subjDlg.addField('Counterbalance Order?:') #5
subjDlg.show()
...
run_data = {
    ...
    #'Counterbalance Order': counterbalance
    }
...
instruct_screen1 = visual.TextStim(win, text = "Remember, you will decide whether to accept/reject offers in this task.", pos = (0,5), wrapWidth=20, height = 1.2)
...
#sampleImage1 = os.path.join(expdir,'Images','faces_2','practice.jpg')
...
Young_male_faces = [img for img in os.listdir('Images/experiment/faces_male_young') if 'h' in img]
Young_female_faces = [img for img in os.listdir('Images/experiment/faces_female_young') if 'h' in img]
Middle_male_faces = [img for img in os.listdir('Images/experiment/faces_male_middle') if 'h' in img]
Middle_female_faces = [img for img in os.listdir('Images/experiment/faces_female_middle') if 'h' in img]
Old_male_faces = [img for img in os.listdir('Images/experiment/faces_male_old') if 'h' in img]
Old_female_faces = [img for img in os.listdir('Images/experiment/faces_female_old') if 'h' in img]
...
run1_faces=Young_male_faces[0:7]+Young_female_faces[0:7]+Middle_male_faces[0:7]+Middle_female_faces[0:7]+Old_male_faces[0:7]+Old_female_faces[0:7]
run2_faces=Young_male_faces[8:15]+Young_female_faces[8:15]+Middle_male_faces[8:15]+Middle_female_faces[8:15]+Old_male_faces[8:15]+Old_female_faces[8:15]
...
def do_run(run, trials):
    ...
    for trial in trials:
        ...
        # 1 = Commented out, 2 = Nonsocial, 3 = Social
        if trial['Block'] == '3':         #UG Social Condition
            ...
            while timer.getTime() < 0.5:
                ...
                cue = os.path.join(imagepath,'experiment','all_faces', filefind)
            ...
            trial['Block'] == '2' # Non social condition
            while timer.getTime() < 0.5:
