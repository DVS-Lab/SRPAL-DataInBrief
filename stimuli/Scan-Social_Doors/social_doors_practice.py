...
subjDlg.addField('Type:', choices=['faces', 
                                    'doors'])
subjDlg.addField('Version:', choices=['practice'])
...
instruct_screen_image_practice = visual.TextStim(win, text=instruction_hello_door_practice, pos = (.5,0), wrapWidth=45, height = 1.2)
instruct_screen_face_practice = visual.TextStim(win, text=instruction_hello_face_practice, pos = (.5,0), wrapWidth=45, height = 1.2)
...
instruct_screen3_image = visual.TextStim(win, text=instruction3_door, pos = (0,0), wrapWidth=25, height = 1.2)
...
def do_run(stimset):
    ...
    if version == 'practice':
        if stimset == 'faces':
            instruct_screen_face_practice.draw()
        else:
            instruct_screen_image_practice.draw()
    else:
        if stimset == 'faces':
