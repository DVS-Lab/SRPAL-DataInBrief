...
#instructions
instruct_screen = visual.TextStim(win, text='Welcome to the Card Guessing Game!\n\nIn this game you will have to guess the numerical value of a card for a chance to win some money.\n\nPress the blue button (index finger) to guess lower than 5.\nPress the yellow button (middle finger) to guess higher than 5.', pos = (0,1), wrapWidth=20, height = 1.2)
instruct_screen2 = visual.TextStim(win, text='Remember, you will be sharing monetary outcomes on each round with the partner displayed at the top of the screen––either the computer or a previous participant.\n\nIf you guess correctly, you and your partner earn $20 ($10 each).\n If you guess incorrectly, you and your partner lose $10 ($5 each).', pos = (0,1), wrapWidth=20, height = 1.2)
